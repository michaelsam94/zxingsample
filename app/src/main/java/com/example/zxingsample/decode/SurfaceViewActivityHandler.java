 ...
 */
public final class SurfaceViewActivityHandler extends Handler {
    private static final String TAG = SurfaceViewActivityHandler.class.getName();
    ...
    public SurfaceViewActivityHandler(SurfaceViewActivity activity) {
